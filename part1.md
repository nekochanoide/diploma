...
Есть норматив для зданий по освещенности помещений. Если помещения недостаточно освещены, то в них будет сложно жить/работать/рожать/учиться/воспитывать детей/делать выставки и так далее. Так же освещенность влияет на психику человека. Если проводить много времени в теменоте, то может поехать крыша.

Такой расчет называется КЕО (коэффициент естественной освещенности). С ним связаны ряд документов - СП 52.13330.2016, СП 367.1325800.2017, СП 23-102-203, СанПиН 2.2.1/2.1.1.1278-03 и возможно еще какие-то.
...
Пограммное обеспечение, которое решает задачи, связанные с освещением, использует техники, которые называются трассировка лучей и излучение (radiosity) ([небольшое старое исследование, которое попалось](bs05_0183_190.pdf)). Расчет идет путём отслеживания взаимодействия отдельных лучей с поверхностями. В узком смысле — технология построения изображения трёхмерных моделей в компьютерных программах, при которых отслеживается обратная траектория распространения луча (от экрана к источнику). [Источник на вики про рейтрейсинг](https://ru.wikipedia.org/wiki/Трассировка_лучей)
